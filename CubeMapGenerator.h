...
public:
	...
	void init() {
		...
		irradianceMapShader = Shader("Data/Shaders/skybox.vert", "Data/Shaders/irradianceMap.frag");
		prefilterShader = Shader("Data/Shaders/skybox.vert", "Data/Shaders/prefilter.frag"); 
		cube.init();
		
	}
	unsigned int generateCubeMap(int w,int h,unsigned int texture) {
		state = true;
	...
	unsigned int generateIrradianceMap() {
		...
		for (unsigned int i = 0; i < 6; ++i)
		{
			...
			cube.draw(irradianceMapShader);
		}
		glBindFramebuffer(GL_FRAMEBUFFER, 0);
		return irradianceMap;
	}

	unsigned int prefilterMapGeneration() {
